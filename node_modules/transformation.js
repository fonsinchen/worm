exports.bind = function(descriptor, table, store) {
    ...
    table.columns.forEach(function(name, props) {
        if (props.pkey) pkey.push(store.column(table, name));
    });
    ...
    return {
        extract : function(row, results, track) {
            ...
            pkey.forEach(function(key) {
                var keyVal = row[key.alias];
    ...
    return {
        bind : function(key, table, store, name) {
            ...
            if (typeof descriptor.bind === 'function') {
                ...
                column = store.column(table, descriptor);
            }
            return {
                extract : function(row, result, track, isNew) {
                    if (bound !== null) {
...
exports.expr = function(expr, insertExprs) {
    ...
    return {
        bind : function(key, table, store, name) {
            if (name === undefined) name = key;
            var alias = store.selectExpression(name, parseTree)
            parsedInserts.foreach(function(key, insert) {
