    ...
    return {
        ...
        collect : function(obj, row) {
            transformation.forEach(function(child) {
                child.save(obj, row); // mode should be irrelevant here
            });
        ...
        save : function(obj, exec, keys, end) {
            var row = {};
            ...
            var doInsert = function() {
                ...
                pkey.forEach(function(alias, column) {
                    pkeyVals[column.name] = row[column.name];
                ...
                exec(table, row, pkeyVals, handleMany);
            };

            var handleMany = function(key) {
                // if there are either one- or many-joins we have to postpone
                // until all of those have been completed. Otherwise, this is
                // the logical place to call end.
                // We cannot use oneJoins or allJoins here as part of the joins
                // may already have been completed.
                if (one.length === 0 && many.length === 0 && end !== undefined) {
                    end();
                }
                var rowKeys = {};
                pkey.forEach(function(alias, column) {
            ...
            if (oneJoins === 0) {
                ...
                one.forEach(function(child) {
                    child.save(obj, exec, function(childKey, childRow) {
    ...
    return {
        bind : function(key, table, store, name) {
            ...
            return {
                ...
                save : function(obj, exec, keys, end) {
                    bound.save(obj[name], exec, keys, end);
                },
                fkeys : bound.fkeys
            }
        },
            ...
            return {
                ...
                save : function(obj, exec, keys, end) {
                    ...
                    obj[name].forEach(function(child) {
                        bound.save(child, exec, keys, function() {
    ...
    return {
        bind : function(key, table, store, name) {
            ...
            return {
                ...
                save : function(obj, rowOrExec, keys, end) {
                    if (bound !== null) {
                        bound.save(obj, rowOrExec, keys, end);
                    } else if (descriptor === undefined) {
    ...
    return {
        bind : function(key, table, store, name) {
            ...
            return {
                ...
                save : function(obj, rowOrExec, keys, end) {
                    if (descriptor.joins) {
                        bound.save(obj[name], rowOrExec, keys, end);
                    } else {
