...
module.exports = function(descriptor, model, tableDesc) {
    ...
    var join = function(parent, key, direction, condition) {
        ...
        if (direction === 'lkeys') {
            ...
            foreign.foreign.forEach(function(column, i) {
                child.fkeys[foreign.local[i]] = column;
            });
        } else {
            foreign.local.forEach(function(column, i) {
                child.fkeys[foreign.foreign[i]] = column;
            });
        }
        if (condition === undefined) {
            condition = [];
            child.fkeys.forEach(function(l, f) {
    ...
    return {
        ...
        save : function(obj, exec, end) {
            return base.save(obj, exec, undefined, end);
        },
